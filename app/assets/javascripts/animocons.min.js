 ...
 */
'use strict';
function isIOSSafari(){var a;a=window.navigator.userAgent;return a.match(/iPad/i)||a.match(/iPhone/i)}function isTouch(){var a;a=navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0;return[].indexOf.call(window,"ontouchstart")>=0||a}var isIOS=isIOSSafari(),clickHandler=isIOS||isTouch()?"touchstart":"click";function extend(d,c){for(var e in c){if(c.hasOwnProperty(e)){d[e]=c[e]}}return d}function hasClass_js(d,b){var b=b;var c=" "+b+" ";var a=d.length;if((" "+d.className+" ").replace(/[\t\r\n\f]/g," ").indexOf(c)>=0){return true}return false}function Animocon(e,c){this.el=e;this.once=function(){if((" "+this.el.className+" ").replace(/[\t\r\n\f]/g," ").indexOf(" once ")>=0){return true}else{return false}};this.done=false;this.options=extend({},this.options);extend(this.options,c);this.checked=false;this.timeline=new mojs.Timeline();for(var d=0,a=this.options.tweens.length;d<a;++d){this.timeline.add(this.options.tweens[d])}var b=this;this.el.addEventListener(clickHandler,function(){if(b.checked){if(!b.done){b.options.onUnCheck()}}else{if(!b.done){b.options.onCheck();b.timeline.replay()}if(b.once()){b.done=true}}b.checked=!b.checked})}Animocon.prototype.options={tweens:[new mojs.Burst({})],onCheck:function(){return false},onUnCheck:function(){return false}};function init(E,y,x,g){var M=E.querySelector("span");if(y==1){new Animocon(E,{tweens:[new mojs.Burst({parent:E,radius:{30:90},count:6,children:{fill:x,opacity:0.6,radius:15,duration:1700,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Shape({parent:E,type:"circle",radius:{0:60},fill:"transparent",stroke:x,strokeWidth:{20:0},opacity:0.6,duration:700,easing:mojs.easing.sin.out}),new mojs.Tween({duration:1200,onUpdate:function(Q){if(Q>0.3){var P=mojs.easing.elastic.out(1.43*Q-0.43);M.style.WebkitTransform=M.style.transform="scale3d("+P+","+P+",1)"}else{M.style.WebkitTransform=M.style.transform="scale3d(0,0,1)"}},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){E.style.color=g},onUnCheck:function(){E.style.color=x}})}else{if(y==2){new Animocon(E,{tweens:[new mojs.Burst({parent:E,count:6,radius:{40:90},timeline:{delay:300},children:{fill:x,radius:7,opacity:0.6,duration:1500,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Shape({parent:E,radius:{0:50},fill:"transparent",stroke:x,strokeWidth:{35:0},opacity:0.6,duration:600,easing:mojs.easing.ease.inout}),new mojs.Tween({duration:1100,onUpdate:function(Q){if(Q>0.3){var P=mojs.easing.elastic.out(1.43*Q-0.43);M.style.WebkitTransform=M.style.transform="scale3d("+P+","+P+",1)"}else{M.style.WebkitTransform=M.style.transform="scale3d(0,0,1)"}},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){E.style.color=g},onUnCheck:function(){E.style.color=x}})}else{if(y==3){new Animocon(E,{tweens:[new mojs.Burst({parent:E,count:6,radius:{40:90},children:{fill:["#988ADE","#DE8AA0","#8AAEDE","#8ADEAD","#DEC58A","#8AD1DE"],opacity:0.6,scale:1,radius:{7:0},duration:1500,delay:300,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Shape({parent:E,type:"circle",scale:{0:1},radius:50,fill:"transparent",stroke:g,strokeWidth:{35:0},opacity:0.6,duration:750,easing:mojs.easing.bezier(0,1,0.5,1)}),new mojs.Tween({duration:1100,onUpdate:function(Q){if(Q>0.3){var P=mojs.easing.elastic.out(1.43*Q-0.43);M.style.WebkitTransform=M.style.transform="scale3d("+P+","+P+",1)"}else{M.style.WebkitTransform=M.style.transform="scale3d(0,0,1)"}},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){E.style.color=g},onUnCheck:function(){E.style.color=x}})}else{if(y==4){var O=mojs.easing.path("M0,100 L25,99.9999983 C26.2328835,75.0708847 19.7847843,0 100,0");new Animocon(E,{tweens:[new mojs.Burst({parent:E,count:6,radius:{40:120},children:{fill:["#988ADE","#DE8AA0","#8AAEDE","#8ADEAD","#DEC58A","#8AD1DE"],opacity:0.6,radius:20,direction:[-1,-1,-1,1,-1],swirlSize:"rand(10, 14)",duration:1500,easing:mojs.easing.bezier(0.1,1,0.3,1),isSwirl:true}}),new mojs.Shape({parent:E,radius:50,scale:{0:1},fill:"transparent",stroke:g,strokeWidth:{15:0},opacity:0.6,duration:750,easing:mojs.easing.bezier(0,1,0.5,1)}),new mojs.Tween({duration:900,onUpdate:function(P){var Q=O(P);M.style.WebkitTransform=M.style.transform="scale3d("+Q+","+Q+",1)"},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){E.style.color=g},onUnCheck:function(){E.style.color=x}})}else{if(y==5){var L=mojs.easing.path("M0,100 L25,99.9999983 C26.2328835,75.0708847 19.7847843,0 100,0");new Animocon(E,{tweens:[new mojs.Burst({parent:E,count:15,radius:{20:80},angle:{0:140,easing:mojs.easing.bezier(0.1,1,0.3,1)},children:{fill:g,radius:20,opacity:0.6,duration:1500,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Tween({duration:800,easing:mojs.easing.bezier(0.1,1,0.3,1),onUpdate:function(P){var Q=L(P);M.style.WebkitTransform=M.style.transform="scale3d("+P+","+P+",1)"},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){E.style.color=g},onUnCheck:function(){E.style.color=x}})}else{if(y==6){var K=mojs.easing.path("M0,100 L25,99.9999983 C26.2328835,75.0708847 19.7847843,0 100,0");new Animocon(E,{tweens:[new mojs.Burst({parent:E,radius:{40:110},count:20,children:{shape:"line",fill:"white",radius:{12:0},scale:1,stroke:g,strokeWidth:2,duration:1500,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Shape({parent:E,radius:{10:60},fill:"transparent",stroke:g,strokeWidth:{30:0},duration:800,easing:mojs.easing.bezier(0.1,1,0.3,1)}),new mojs.Tween({duration:800,easing:mojs.easing.bezier(0.1,1,0.3,1),onUpdate:function(P){var Q=K(P);M.style.WebkitTransform=M.style.transform="scale3d("+P+","+P+",1)"},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){E.style.color=g},onUnCheck:function(){E.style.color=x}})}else{if(y==7){new Animocon(E,{tweens:[new mojs.Burst({parent:E,radius:{90:150},count:18,children:{fill:g,opacity:0.6,scale:1,radius:{"rand(5,20)":0},swirlSize:15,direction:[1,1,-1,-1,1,1,-1,-1,-1],duration:1200,delay:200,easing:mojs.easing.bezier(0.1,1,0.3,1),isSwirl:true}}),new mojs.Shape({parent:E,radius:{30:100},fill:"transparent",stroke:g,strokeWidth:{30:0},opacity:0.6,duration:1500,easing:mojs.easing.bezier(0.1,1,0.3,1)}),new mojs.Shape({parent:E,radius:{30:80},fill:"transparent",stroke:g,strokeWidth:{20:0},opacity:0.3,duration:1600,delay:320,easing:mojs.easing.bezier(0.1,1,0.3,1)}),new mojs.Tween({duration:1000,onUpdate:function(Q){if(Q>0.3){var P=mojs.easing.elastic.out(1.43*Q-0.43);M.style.WebkitTransform=M.style.transform="scale3d("+P+","+P+",1)"}else{M.style.WebkitTransform=M.style.transform="scale3d(0,0,1)"}},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){E.style.color=g},onUnCheck:function(){E.style.color=x}})}else{if(y==8){var I=mojs.easing.path("M0,100 L25,99.9999983 C26.2328835,75.0708847 19.7847843,0 100,0");new Animocon(E,{tweens:[new mojs.Burst({parent:E,count:28,radius:{50:110},children:{fill:g,opacity:0.6,radius:{"rand(5,20)":0},scale:1,swirlSize:15,duration:1600,easing:mojs.easing.bezier(0.1,1,0.3,1),isSwirl:true}}),new mojs.Burst({parent:E,count:18,angle:{0:10},radius:{140:200},children:{fill:g,shape:"line",opacity:0.6,radius:{"rand(5,20)":0},scale:1,stroke:g,strokeWidth:2,duration:1800,delay:300,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Burst({parent:E,radius:{40:80},count:18,children:{fill:g,opacity:0.6,radius:{"rand(5,20)":0},scale:1,swirlSize:15,duration:2000,delay:500,easing:mojs.easing.bezier(0.1,1,0.3,1),isSwirl:true}}),new mojs.Burst({parent:E,count:20,angle:{0:-10},radius:{90:130},children:{fill:g,opacity:0.6,radius:{"rand(10,20)":0},scale:1,duration:3000,delay:750,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Tween({duration:400,easing:mojs.easing.back.out,onUpdate:function(P){var Q=I(P);M.style.WebkitTransform=M.style.transform="scale3d("+P+","+P+",1)"},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){E.style.color=g},onUnCheck:function(){E.style.color=x}})}else{if(y==9){M.style.WebkitTransformOrigin=M.style.transformOrigin="-10% 50%";new Animocon(E,{tweens:[new mojs.Burst({parent:E,count:6,radius:{40:90},angle:135,degree:90,children:{fill:["#988ADE","#DE8AA0","#8AAEDE","#8ADEAD","#DEC58A","#8AD1DE"],scale:1,radius:{7:0},opacity:0.6,duration:1500,delay:350,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Burst({parent:E,count:6,angle:45,degree:-90,radius:{40:100},children:{fill:["#988ADE","#DE8AA0","#8AAEDE","#8ADEAD","#DEC58A","#8AD1DE"],scale:1,radius:{7:0},opacity:0.6,duration:1500,delay:550,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Shape({parent:E,radius:{0:50},fill:"transparent",stroke:g,strokeWidth:{35:0},opacity:0.6,duration:750,easing:mojs.easing.bezier(0,1,0.5,1)}),new mojs.Shape({parent:E,radius:{0:50},fill:"transparent",stroke:g,strokeWidth:{35:0},opacity:0.6,duration:750,delay:200,easing:mojs.easing.bezier(0,1,0.5,1)}),new mojs.Tween({duration:1500,onUpdate:function(Q){if(Q>0.3){var P=mojs.easing.elastic.out(1.43*Q-0.43);M.style.WebkitTransform=M.style.transform="scale3d("+P+","+P+",1) rotate3d(0,0,1,"+90*(1-P)+"deg)"}else{M.style.WebkitTransform=M.style.transform="scale3d(0,0,1)"}},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){E.style.color=g},onUnCheck:function(){E.style.color=x}})}else{if(y==10){var u=E,A=M;var k=mojs.easing.path("M1,0 C1,0 26,100 51,100 C76,100 101,0 101,0");var J=mojs.easing.path("M0,100 C0,0 50,0 50,0 L50,100 L50,200 C50,200 50,100 100,100");var a=mojs.easing.path("M0,100 L50,100 L50,0 L100,0");new Animocon(u,{tweens:[new mojs.Burst({parent:u,radius:{80:130},degree:90,angle:135,count:6,children:{shape:"line",fill:x,scale:1,radius:{30:0},opacity:0.6,duration:600,stroke:g,strokeWidth:{1:2},easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Tween({duration:400,easing:mojs.easing.ease.out,onUpdate:function(P){var S=k(P);A.style.opacity=S;var R=J(P);A.style.WebkitTransform=A.style.transform="translate3d(0,"+-150*R+"%,0)";var Q=a(P);u.style.color=Q?g:x},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){},onUnCheck:function(){u.style.color=x}})}else{if(y==11){var t=E,v=M;var h=mojs.easing.path("M0,0 C0,87 27,100 40,100 L40,0 L100,0");var B=mojs.easing.path("M0,0c0,80,39.2,100,39.2,100L40-100c0,0-0.7,106,60,106");new Animocon(t,{tweens:[new mojs.Shape({parent:t,radius:{0:95},fill:"transparent",stroke:x,strokeWidth:{50:0},opacity:0.4,duration:1000,delay:100,easing:mojs.easing.bezier(0,1,0.5,1)}),new mojs.Shape({parent:t,radius:{0:80},fill:"transparent",stroke:x,strokeWidth:{40:0},opacity:0.2,duration:1800,delay:300,easing:mojs.easing.bezier(0,1,0.5,1)}),new mojs.Tween({duration:1300,easing:mojs.easing.ease.out,onUpdate:function(P){var R=h(P);v.style.opacity=R;var S=B(P);v.style.WebkitTransform=v.style.transform="scale3d("+S+","+S+",1)";var Q=h(P);t.style.color=Q>=1?g:x},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onUnCheck:function(){t.style.color=x}})}else{if(y==12){var s=E,e=M;var f=mojs.easing.path("M0,100 L20,100 L20,1 L100,1");var H=mojs.easing.path("M0,100h20V0c0,0,0.2,101,80,101");new Animocon(s,{tweens:[new mojs.Burst({parent:s,count:2,radius:{10:90},angle:92,top:"90%",children:{shape:"line",fill:x,scale:1,radius:{40:0},stroke:x,strokeWidth:{4:1},strokeLinecap:"round",opacity:0.5,duration:500,delay:200,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Burst({parent:s,count:3,radius:{10:40},angle:182,top:"90%",children:{shape:"line",fill:x,opacity:0.5,scale:1,radius:{10:0},stroke:x,strokeWidth:{4:1},strokeLinecap:"round",duration:600,delay:200,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Shape({parent:s,radius:{40:0},radiusY:{20:0},fill:x,stroke:x,strokeWidth:1,opacity:0.3,top:"90%",duration:400,delay:100,easing:"bounce.out"}),new mojs.Tween({duration:500,easing:mojs.easing.bounce.out,onUpdate:function(P){var R=H(P);e.style.WebkitTransform=e.style.transform="translate3d(0,"+-450*R+"%,0)";var Q=f(P);s.style.color=Q?g:x},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onUnCheck:function(){s.style.color=x}})}else{if(y==13){var r=E,G=M;new Animocon(r,{tweens:[new mojs.Burst({parent:r,count:3,degree:0,radius:{80:250},angle:-90,children:{top:[0,45,0],left:[-25,0,25],shape:"line",fill:x,radius:{60:0},scale:1,stroke:g,opacity:0.6,duration:650,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Burst({parent:r,count:6,radius:{60:90},degree:-90,angle:135,children:{shape:"line",radius:{30:0},scale:1,stroke:g,strokeWidth:{2:1},duration:600,delay:200,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Tween({duration:1200,onUpdate:function(Q){var P=mojs.easing.elastic.out(Q);G.style.WebkitTransform=G.style.transform="translate3d("+-75*(1-P)+"%,0,0)"},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){r.style.color=g},onUnCheck:function(){r.style.color=x}})}else{if(y==14){var q=E,w=M;new Animocon(q,{tweens:[new mojs.Shape({parent:q,duration:750,type:"circle",radius:{0:40},fill:"transparent",stroke:g,strokeWidth:{35:0},opacity:0.2,top:"45%",easing:mojs.easing.bezier(0,1,0.5,1)}),new mojs.Shape({parent:q,duration:500,delay:100,type:"circle",radius:{0:20},fill:"transparent",stroke:g,strokeWidth:{5:0},opacity:0.2,x:40,y:-60,easing:mojs.easing.sin.out}),new mojs.Shape({parent:q,duration:500,delay:180,type:"circle",radius:{0:10},fill:"transparent",stroke:g,strokeWidth:{5:0},opacity:0.5,x:-10,y:-80,isRunLess:true,easing:mojs.easing.sin.out}),new mojs.Shape({parent:q,duration:800,delay:240,type:"circle",radius:{0:20},fill:"transparent",stroke:g,strokeWidth:{5:0},opacity:0.3,x:-70,y:-10,easing:mojs.easing.sin.out}),new mojs.Shape({parent:q,duration:800,delay:240,type:"circle",radius:{0:20},fill:"transparent",stroke:g,strokeWidth:{5:0},opacity:0.4,x:80,y:-50,easing:mojs.easing.sin.out}),new mojs.Shape({parent:q,duration:1000,delay:300,type:"circle",radius:{0:15},fill:"transparent",stroke:g,strokeWidth:{5:0},opacity:0.2,x:20,y:-100,easing:mojs.easing.sin.out}),new mojs.Shape({parent:q,duration:600,delay:330,type:"circle",radius:{0:25},fill:"transparent",stroke:g,strokeWidth:{5:0},opacity:0.4,x:-40,y:-90,easing:mojs.easing.sin.out}),new mojs.Tween({duration:1200,easing:mojs.easing.ease.out,onUpdate:function(Q){if(Q>0.3){var P=mojs.easing.elastic.out(1.43*Q-0.43);w.style.WebkitTransform=w.style.transform="scale3d("+P+","+P+",1)"}else{w.style.WebkitTransform=w.style.transform="scale3d(0,0,1)"}},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){q.style.color=g},onUnCheck:function(){q.style.color=x}})}else{if(y==15){var p=E,m=M;var d=mojs.easing.path("M1,0 C1,0 26,100 51,100 C76,100 101,0 101,0");var F=mojs.easing.path("M0,100 C0,0 50,0 50,0 L50,100 L50,200 C50,200 50,100 100,100");var N=mojs.easing.path("M0,100 L50,100 L50,0 L100,0");new Animocon(p,{tweens:[new mojs.Burst({parent:p,top:"90%",count:1,radius:{30:100},degree:20,angle:-90,children:{shape:"line",fill:x,radius:{60:0},scale:1,stroke:g,opacity:0.6,duration:600,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Tween({duration:400,easing:mojs.easing.ease.inout,onUpdate:function(P){var S=d(P);m.style.opacity=S;var R=F(P);m.style.WebkitTransform=m.style.transform="translate3d("+350*R+"%,0,0)";var Q=N(P);p.style.color=Q?g:x},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onUnCheck:function(){p.style.color=x}})}else{if(y==16){var n=E,b=M;var c=mojs.easing.path("M0,0 L25.333,0 L75.333,100 L100,0");var D=mojs.easing.path("M0,100h25.3c0,0,6.5-37.3,15-56c12.3-27,35-44,35-44v150c0,0-1.1-12.2,9.7-33.3c9.7-19,15-22.9,15-22.9");var o=mojs.easing.path("M0,100.004963 C0,100.004963 25,147.596355 25,100.004961 C25,70.7741867 32.2461944,85.3230873 58.484375,94.8579105 C68.9280825,98.6531013 83.2611815,99.9999999 100,100");new Animocon(n,{tweens:[new mojs.Burst({parent:n,count:6,radius:{0:150},degree:50,angle:-25,opacity:0.3,children:{fill:g,scale:1,radius:{"rand(5,15)":0},duration:1700,delay:350,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Burst({parent:n,count:3,degree:0,radius:{80:250},angle:180,children:{top:[45,0,45],left:[-15,0,15],shape:"line",radius:{60:0},scale:1,stroke:g,opacity:0.4,duration:650,delay:200,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Tween({duration:500,onUpdate:function(R){var U=D(R),T=o(R),Q=1-2*T,P=1+2*T;b.style.WebkitTransform=b.style.transform="translate3d(0,"+-180*U+"px,0) scale3d("+Q+","+P+",1)";var S=c(R);b.style.opacity=S;n.style.color=R>=0.75?g:x},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onUnCheck:function(){n.style.color=x}})}else{if(y==17){var l=E,z=M;var C=mojs.easing.path("M0,100 C0,72 10,-0.1 50,0 C89.6,0.1 100,72 100,100");new Animocon(l,{tweens:[new mojs.Burst({parent:l,left:"65%",top:"40%",count:5,radius:{40:120},angle:69,degree:17,children:{shape:"line",scale:1,radius:{20:0},stroke:["#bf62a6","#f28c33","#f5d63d","#79c267","#78c5d6"],duration:600,easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Burst({parent:l,left:"65%",top:"40%",count:4,radius:{20:50},degree:20,angle:70,opacity:0.6,children:{fill:["#bf62a6","#f28c33","#f5d63d","#79c267","#78c5d6"],scale:1,radius:{"rand(5,20)":0},isSwirl:true,swirlSize:4,duration:1600,delay:[0,350,200,150,400],easing:mojs.easing.bezier(0.1,1,0.3,1)}}),new mojs.Tween({duration:800,easing:mojs.easing.bezier(0.1,1,0.3,1),onUpdate:function(P){var Q=C(P);z.style.WebkitTransform=z.style.transform="translate3d("+-20*Q+"%,0,0)"},onStart:function(){E.style.overflow="visible"},onComplete:function(){E.style.overflow="hidden"}})],onCheck:function(){l.style.color=g},onUnCheck:function(){l.style.color=x}})}}}}}}}}}}}}}}}}}}var colors={red:"#ff8077",blue:"#6f97f7",green:"#99d892",yellow:"#ffeb3b",orange:"#ffb367",pink:"#f35186",purple:"#988ADE",white:"#fff",grey:"#c0c1c3",black:"#000"};var items=[].slice.call(document.querySelectorAll("button.icobutton"));for(var i=items.length-1;i>=0;i--){items[i].id="icobutton"+i;var el=document.getElementById("icobutton"+i),anim,colorStart,colorEnd;var cls=el.className.split(" ");for(var j=cls.length-1;j>=0;j--){if(cls[j].replace(/[\t\r\n\f]/g," ").indexOf("icobutton-")>=0){var param=cls[j].split("-");anim=param[1];if(param[2]){if(colors[param[2]]){colorStart=colors[param[2]]}else{if(param[2].match(/^([0-9a-f]{6}|[0-9a-f]{3})$/i)){colorStart="#"+param[2]}else{colorStart="#c0c1c3"}}}else{colorStart="#c0c1c3"}if(param[3]){if(colors[param[3]]){colorEnd=colors[param[3]]}else{if(param[3].match(/^([0-9a-f]{6}|[0-9a-f]{3})$/i)){colorEnd="#"+param[3]}else{colorEnd="#c0c1c3"}}}else{colorEnd="#c0c1c3"}}}el.style.color=colorStart;el.style.overflow="hidden";init(el,anim,colorStart,colorEnd)};
}, false );